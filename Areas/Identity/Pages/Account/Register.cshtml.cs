...
namespace GameVault.Areas.Identity.Pages.Account
{
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirma tu correo electrónico",
                        $"Haga clic aquí para confirmar su cuenta: <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>confirmar cuenta</a>.");
